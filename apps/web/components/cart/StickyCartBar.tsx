...
const NORMAL_CART_TOP = 82;
const PRODUCT_PAGE_CART_TOP = 0;
...
export default function StickyCartBar() {
  ...
  !hideStickyCart && (
        <div
          className="fixed left-1/2 z-[60] h-[146px] w-[250px] -translate-x-1/2 md:hidden"
          style={{
            bottom:
        ...
        >
          <motion.div
            ...
            className="absolute left-0 h-16 w-[250px]"
          >
            <motion.div
              ...
              className="relative h-16 w-[250px]"
            >
              <motion.button
                type="button"
                onClick={openCart}
                  ...
                  {visibleProducts.map(
                    (item, index) => {
                      ...
                      return (
                        <motion.div
  layout="position"
  layoutDependency={visibleProductsKey}
  key={item.cartKey}
                          initial={{
                            y: -48,
                            opacity: 0,
